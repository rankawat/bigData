 ...
 */
package Java.bigdata.code.crunch;
...
public class WordAggregationHBase extends Configured implements Tool, Serializable {
     ...
     * @return a {@code PTable} composed of the type of the input as key and its
     * def as value
     */
     ...
     *
     * @param extractedText a PTable which contain the data in order to create
     * the puts: keys of the PTable are rowkeys for the puts, values are the
     * values for hbase.
